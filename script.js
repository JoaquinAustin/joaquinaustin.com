...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (v2SwitchEls.length) {
    // Simple sequential fade: the outgoing content fades fully to
    ...
    // Full Case and Keep it short have different content — for a
    // moment you'd see both the TOC and the short summary, or both
    // the lead paragraph and the "Overview" heading, stacked on top
    // of each other.
    const FADE_MS = 200;
    let timers = [];
    const clearV2Timers = () => {
